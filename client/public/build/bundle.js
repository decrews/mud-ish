...
var app = (function () {
    ...
    */
    ...
    /* C:\Users\Danielle\Documents\repos\chat\client\src\Components\UserList.svelte generated by Svelte v3.24.1 */
    ...
    // (6:4) {#each users as user (user.id)}
    function create_each_block(key_1, ctx) {
    	...
    	const block = {
    		...
    		c: function create() {
    			...
    			t0 = text(t0_value);
    			t1 = space();
    			add_location(p, file, 7, 12, 118);
    			add_location(div, file, 6, 8, 99);
    			this.first = div;
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(6:4) {#each users as user (user.id)}",
    		ctx
    	});
    ...
    /* C:\Users\Danielle\Documents\repos\chat\client\src\Components\ChatBox.svelte generated by Svelte v3.24.1 */
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t1 = text(" - ");
    			t2 = text(t2_value);
    			attr_dev(p, "class", "svelte-n6oaw3");
    			add_location(p, file$1, 18, 16, 424);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			p = element("p");
    			t = text(t_value);
    			attr_dev(p, "class", "server-message svelte-n6oaw3");
    			add_location(p, file$1, 21, 16, 552);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, p, anchor);
    			append_dev(p, t);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(21:12) {#if message.id === 'server'}",
    		ctx
    	});
    ...
    // (17:8) {#each messages as message (message.id + message.time + message.text)}
    function create_each_block$1(key_1, ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(17:8) {#each messages as message (message.id + message.time + message.text)}",
    		ctx
    	});
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "message-box svelte-n6oaw3");
    			add_location(div, file$1, 15, 4, 269);
    			attr_dev(input_1, "type", "text");
    			add_location(input_1, file$1, 26, 8, 698);
    			add_location(form, file$1, 25, 4, 650);
    			attr_dev(main, "class", "svelte-n6oaw3");
    			add_location(main, file$1, 14, 0, 257);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    class ChatBox extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$1, create_fragment$1, safe_not_equal, { messages: 1, sendMessage: 4, message: 0 });
    		...
    		if (/*sendMessage*/ ctx[4] === undefined && !("sendMessage" in props)) {
    ...
    /* C:\Users\Danielle\Documents\repos\chat\client\src\App.svelte generated by Svelte v3.24.1 */

    const { console: console_1 } = globals;
    const file$2 = "C:\\Users\\Danielle\\Documents\\repos\\chat\\client\\src\\App.svelte";
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "content svelte-e0dlg5");
    			add_location(div, file$2, 74, 2, 1942);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t5 = space();
    			input = element("input");
    			attr_dev(h1, "class", "dgreen svelte-e0dlg5");
    			add_location(h1, file$2, 69, 2, 1805);
    			add_location(button, file$2, 70, 2, 1845);
    			attr_dev(input, "type", "text");
    			add_location(input, file$2, 71, 2, 1891);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			main = element("main");
    			if_block.c();
    			attr_dev(main, "class", "svelte-e0dlg5");
    			add_location(main, file$2, 67, 0, 1781);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	return [socket, messages, userList, name, connect, sendMessage, input_input_handler];
    }
