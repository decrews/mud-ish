...
var app = (function () {
    ...
    */
    ...
    /* C:\Users\Danielle\Documents\repos\chat\client\src\Components\UserList.svelte generated by Svelte v3.25.0 */

    const file = "C:\\Users\\Danielle\\Documents\\repos\\chat\\client\\src\\Components\\UserList.svelte";
    ...
    // (7:2) {#each users as user (user.id)}
    function create_each_block(key_1, ctx) {
    	...
    	const block = {
    		...
    		c: function create() {
    			...
    			t0 = text(t0_value);
    			t1 = space();
    			attr_dev(p, "class", "svelte-5nvaxm");
    			add_location(p, file, 8, 6, 132);
    			add_location(div, file, 7, 4, 119);
    			this.first = div;
    		},
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*users*/ 1 && t0_value !== (t0_value = /*user*/ ctx[1].username + "")) set_data_dev(t0, t0_value);
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(7:2) {#each users as user (user.id)}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			main = element("main");
    			h4 = element("h4");
    			h4.textContent = "connected users";
    			t1 = space();
    			...
    			add_location(h4, file, 5, 2, 54);
    			attr_dev(main, "class", "svelte-5nvaxm");
    ...
    class UserList extends SvelteComponentDev {
    	constructor(options) {
    		...
    		if (/*users*/ ctx[0] === undefined && !("users" in props)) {
    			console.warn("<UserList> was created without expected prop 'users'");
    		}
    	}
    ...
    /* C:\Users\Danielle\Documents\repos\chat\client\src\Components\ChatBox.svelte generated by Svelte v3.25.0 */
    const file$1 = "C:\\Users\\Danielle\\Documents\\repos\\chat\\client\\src\\Components\\ChatBox.svelte";
    ...
    function create_if_block_1(ctx) {
    	...
    	let t0;
    	let t1;
    	let t2_value = /*message*/ ctx[0].text + "";
    	let t2;
    	...
    	const block = {
    		c: function create() {
    			...
    			t1 = text(" - ");
    			t2 = text(t2_value);
    			attr_dev(span, "class", "name svelte-1xj088r");
    			add_location(span, file$1, 34, 11, 794);
    			attr_dev(p, "class", "svelte-1xj088r");
    			add_location(p, file$1, 34, 8, 791);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*messages*/ 2 && t0_value !== (t0_value = /*message*/ ctx[0].user.username + "")) set_data_dev(t0, t0_value);
    			if (dirty & /*messages*/ 2 && t2_value !== (t2_value = /*message*/ ctx[0].text + "")) set_data_dev(t2, t2_value);
    		},
    		d: function destroy(detaching) {
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			p = element("p");
    			t = text(t_value);
    			attr_dev(p, "class", "server-message svelte-1xj088r");
    			add_location(p, file$1, 37, 8, 924);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, p, anchor);
    			append_dev(p, t);
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*messages*/ 2 && t_value !== (t_value = /*message*/ ctx[0].text + "")) set_data_dev(t, t_value);
    		},
    		d: function destroy(detaching) {
    			if (detaching) detach_dev(p);
    		}
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(37:6) {#if message.id === 'server'}",
    		ctx
    	});
    ...
    // (33:4) {#each messages as message (message.id + message.time + message.text)}
    function create_each_block$1(key_1, ctx) {
    	let first;
    	let t;
    	let if_block1_anchor;
    	let if_block0 = /*message*/ ctx[0].user && create_if_block_1(ctx);
    	let if_block1 = /*message*/ ctx[0].id === "server" && create_if_block(ctx);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(33:4) {#each messages as message (message.id + message.time + message.text)}",
    		ctx
    	});
    ...
    function create_fragment$1(ctx) {
    	...
    	validate_each_argument(each_value);
    	const get_key = ctx => /*message*/ ctx[0].id + /*message*/ ctx[0].time + /*message*/ ctx[0].text;
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div0, "class", "spacer svelte-1xj088r");
    			add_location(div0, file$1, 31, 4, 657);
    			add_location(span, file$1, 41, 6, 1036);
    			attr_dev(input_1, "class", "text-box svelte-1xj088r");
    			attr_dev(input_1, "type", "text");
    			add_location(input_1, file$1, 43, 8, 1111);
    			attr_dev(form, "class", "svelte-1xj088r");
    			add_location(form, file$1, 42, 6, 1063);
    			attr_dev(div1, "class", "text-container svelte-1xj088r");
    			add_location(div1, file$1, 40, 4, 1000);
    			attr_dev(div2, "class", "message-box svelte-1xj088r");
    			add_location(div2, file$1, 30, 2, 610);
    			attr_dev(main, "class", "svelte-1xj088r");
    			add_location(main, file$1, 29, 0, 600);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			set_input_value(input_1, /*message*/ ctx[0]);
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*message*/ 1 && input_1.value !== /*message*/ ctx[0]) {
    				set_input_value(input_1, /*message*/ ctx[0]);
    			}
    		},
    		i: noop,
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	const writable_props = ["messages", "sendMessage", "message"];

    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console.warn(`<ChatBox> was created with unknown prop '${key}'`);
    	});
    	...
    	const submit_handler = e => onMessage(e);
    	...
    	$$self.$$set = $$props => {
    		...
    		if ("sendMessage" in $$props) $$invalidate(5, sendMessage = $$props.sendMessage);
    ...
    class ChatBox extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$1, create_fragment$1, safe_not_equal, { messages: 1, sendMessage: 5, message: 0 });
    		...
    		if (/*messages*/ ctx[1] === undefined && !("messages" in props)) {
    			console.warn("<ChatBox> was created without expected prop 'messages'");
    		}

    		if (/*sendMessage*/ ctx[5] === undefined && !("sendMessage" in props)) {
    			console.warn("<ChatBox> was created without expected prop 'sendMessage'");
    		}

    		if (/*message*/ ctx[0] === undefined && !("message" in props)) {
    			console.warn("<ChatBox> was created without expected prop 'message'");
    		}
    	}
    ...
    /* C:\Users\Danielle\Documents\repos\chat\client\src\Components\Login.svelte generated by Svelte v3.25.0 */

    const { console: console_1 } = globals;
    const file$2 = "C:\\Users\\Danielle\\Documents\\repos\\chat\\client\\src\\Components\\Login.svelte";
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			form = element("form");
    			input = element("input");
    			attr_dev(h1, "class", "svelte-kczuvj");
    			add_location(h1, file$2, 12, 2, 191);
    			attr_dev(input, "type", "text");
    			add_location(input, file$2, 13, 29, 236);
    			add_location(form, file$2, 13, 2, 209);
    			attr_dev(main, "class", "svelte-kczuvj");
    			add_location(main, file$2, 11, 0, 181);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ name, connect, onSubmit });
    	...
    	return [name, onSubmit, connect, input_input_handler];
    }

    class Login extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$2, create_fragment$2, safe_not_equal, { connect: 2 });
    		...
    		if (/*connect*/ ctx[2] === undefined && !("connect" in props)) {
    			console_1.warn("<Login> was created without expected prop 'connect'");
    		}
    	}
    ...
    /* C:\Users\Danielle\Documents\repos\chat\client\src\App.svelte generated by Svelte v3.25.0 */

    const { console: console_1$1 } = globals;
    const file$3 = "C:\\Users\\Danielle\\Documents\\repos\\chat\\client\\src\\App.svelte";
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "content svelte-1nqzpag");
    			add_location(div, file$3, 71, 4, 2029);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			mount_component(userlist, div, null);
    			append_dev(div, t);
    			mount_component(chatbox, div, null);
    			current = true;
    		},
    		p: function update(ctx, dirty) {
    			const userlist_changes = {};
    			if (dirty & /*userList*/ 4) userlist_changes.users = /*userList*/ ctx[2];
    			userlist.$set(userlist_changes);
    			const chatbox_changes = {};
    			if (dirty & /*messages*/ 2) chatbox_changes.messages = /*messages*/ ctx[1];
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			main = element("main");
    			if_block.c();
    			attr_dev(main, "class", "svelte-1nqzpag");
    			add_location(main, file$3, 67, 0, 1968);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	function onUserMessage(message) {
    		...
    		if (message.id) {
    			...
    			$$invalidate(1, messages = newMessages);
    		}
    	}
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ("messages" in $$props) $$invalidate(1, messages = $$props.messages);
    		if ("userList" in $$props) $$invalidate(2, userList = $$props.userList);
    	};
    	...
    	return [socket, messages, userList, connect, sendMessage];
    }
